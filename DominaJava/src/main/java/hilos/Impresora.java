    ...
    public void imprimir(Object o){
        ...
        try {
            if(impresoraCalidadLock.tryLock(10, TimeUnit.SECONDS)){
                impresoraCalidadLock.lock();
                try{
                    double duracion = Math.random() * 10000;
                    System.out.println(Thread.currentThread().getName() + " : Impresora de calidad imprimiendo un documento durante " + duracion / 1000);
                ...
                try{
                    ...
                    System.out.println(Thread.currentThread().getName() + " : Impresora rápida imprimiendo un documento durante " + duracion / 1000);
                    Thread.sleep((long) duracion);
                }catch (InterruptedException e){
                    e.printStackTrace();
                }finally {
