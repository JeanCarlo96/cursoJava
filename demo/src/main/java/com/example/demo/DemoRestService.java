...
public class DemoRestService {
    ...
    @Operation(summary = "Info del equipo", description = "Información del Equipo",
    tags = {"DemoRestService"})
    @GetMapping("/equipos/{id}")
    public @ResponseBody ResponseEntity<Equipo> getEquipo(@Parameter(description = "id del equipo", required = true, example = "E1", in = ParameterIn.PATH)
    ...
    @Operation(summary = "Actualiza equipo", description = "Actualiza la información de un equipo existente",
    tags = {"DemoRestService"})
    @PutMapping("/equipos/{id}")
    public @ResponseBody ResponseEntity<Equipo> updateEquipo(@Parameter(description = "id del equipo", required = true, example = "E1", in = ParameterIn.PATH)
                                                             @PathVariable(value = "id") String id,
    ...
    @Operation(summary = "Añadir un jugador", description = "Añadir un jugador existente a un equipo",
    tags = {"DemoRestService"})
    @PutMapping("/equipos/{id}/{jugadorId}")
    public @ResponseBody ResponseEntity addJugadorAEquipo(@Parameter(description = "id del equipo", required = true, example = "E1", in = ParameterIn.PATH)
    ...
    public @ResponseBody ResponseEntity addEquipo(
            ...
            @Parameter(description = "Nombre del equipo", required = true, example = "Rojo", in = ParameterIn.QUERY)
